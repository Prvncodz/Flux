    ...
    <div>
      <div className="h-screen w-full overflow-auto">
        <div className="h-auto w-full transition-all flex gap-5 items-center sticky">
          <button onClick={() => navigate("/", { state: { tab: "posts" } })} className="flex flex-start ml-5">
            <ArrowLeft />
          </button>
          <div className="w-80 h-10 rounded-full border border-gray-200 my-2 flex">
            ...
            <div className="h-10 w-18 rounded-4xl bg-gray-100 flex items-center justify-center flex-end" onClick={() => handleSearchPosts()}>
              <Search size={20} />
            </div>
          </div>
        </div>
