...
import { Eye, ThumbsUp, Users, Video, EyeOff, Edit2 } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <button
          className={`text-xs px-3 py-1 w-20 rounded-md text-white active:scale-95 transition-all ${
            isPublished ? "bg-gray-800" : "bg-gray-600"
          }`}
