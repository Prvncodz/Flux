  ...
  return (
    <>
      ...
      <div className="absolute h-screen overflow-hidden w-[30vh] bg-neutral-100  left-0 top-0 z-23 transition-all text-left flex flex-col justify-between  md:z-1  md:h-[95vh] md:mt-18 md:bg-[#ffffff]">
        ...
        <button onClick={onSignout} className="bg-[#1e98fe] hover:bg-blue-600 focus:outline-offset-2 active:bg-blue-800  text-gray-100 p-5 w-38 h-11 ml-auto mr-auto flex justify-center items-center rounded-full font-semibold text-center text-md transition-bg ease cursor-pointer mb-20">
          <SignoutIcon />
