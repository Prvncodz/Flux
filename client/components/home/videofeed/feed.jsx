...
export default function Feed({ fetchType, userId, searchQuery }) {
  ...
  return (
    <>
      <div
        className={`${fetchType === "user" ? `h-[64vh]` : `h-[95vh]`} w-auto overflow-y-auto overflow-x-hidden grid gird-cols-1 gap-6 mb-2 pb-5 scrollbar scrollbar-track-transparent md:grid-cols-2  md:gap-3 md:pl-16 md:pr-5 md:py-4   lg:pl-18 lg:grid-cols-3 lg:pr-4 xl:grid-cols-4 `}
      >
        {areVideosFetched &&
