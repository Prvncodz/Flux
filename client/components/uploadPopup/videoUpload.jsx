          ...
          <div className="px-4 mt-4 text-left flex flex-col gap-6">
            <label className="text-md font-base text-gray-700">
              ...
              <input
                ...
                w-full  p-1  border-graytext-base file:mr-2 file:rounded-full file:border-0 file:bg-violet-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-blue-600 dark:file:text-blue-100 dark:hover:file:bg-blue-500 "
              />
            </label>
            ...
            <label className="text-md font-base text-gray-700">
              ...
              <input
                ...
                className="bg-gray-100
                w-full py-2 px-2 border border-gray-300 placeholder:text-sm"
              />
            </label>
