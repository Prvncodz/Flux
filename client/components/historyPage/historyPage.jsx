...
export default function HistoryPage() {
	...
	return (
		<>
			<Nav />
			<div className="max-w-lg  p-5 h-[95vh] overflow-y-auto rounded-xl md:max-w-full md:ml-20 md:p-5 ">
				...
				{videos.length === 0 ? (
					...
					<div className="space-y-3">
						<h1 className="text-2xl text-left font-semibold mb-6 mt-5">Watch History</h1>
						{videos.map((video) => (
